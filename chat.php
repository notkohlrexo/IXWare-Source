  ...
  <header>
    ...
    <nav id="sidenav-1" class="sidenav bg-dark" data-hidden="false" data-accordion="true">
      ...
      <ul class="sidenav-menu">
        ...
        <li class="sidenav-item">
          <a class="sidenav-link active" href="chat">
            <i class="fas fa-comments-alt fa-fw mr-3"></i><span>Chat</span>
          </a>
        </li>
        <?php
...
<?php
  ...
  <main style="margin-top: 100px" class="d-flex ml-5 mr-5">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12">
                <div class="card chat-card bg-dark" style="display: table;">
                    <div class="card-body d-flex flex-column">
                        <div id="msgarea" class="row">
                            <div class="col-md-4">
                                <div class="online-box-main">
                                    <ul class="list-group list-group-flush" id="users"></ul>
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="message-box-main" id="message-box" style="word-break: break-all;" ;>
                                ...
                                <form id="messageForm">
                                    ...
                                    <div class="form-group">
                                        <div class="md-form mr-3">
                                            <input autocomplete="off" id="message" type="text" class="form-control mt-2 bg-dark text-darkwhite" placeholder="Message" />
                                            <div id="typing"></div>
                                        </div>
                                    </div>
                                </form>
